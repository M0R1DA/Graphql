export function Header(data = {}) {
  ...
  logo.innerHTML = `<img src="${data.avatarUrl}" alt="User Avatar" class="avatar-img"> `?  `<img src="${data.avatarUrl}" alt="User Avatar" class="avatar-img"> <span>${data.login}</span> `:`<i class="fas fa-user-circle"></i> <span>Graph-ql_ZO01</span>`;
...
export function Footer() {
  ...
  footer.innerHTML = `
    <p>&copy; ${new Date().getFullYear()} Z01. morida.</p>
  `;
